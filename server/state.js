...
const state = {
  ...
  settings: { timerSeconds: 30, bidIncrement: 500, timerBumpSeconds: 10, endMode: 'timer', dashboardPin: '', hostPin: '', requireBidConfirm: true, randomizePool: false, spectatorEnabled: true, ownerAverageMultiplier: 1.5 },
  players: [],
